 ...
 */
final class Version20200113151502 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE proprety DROP surface, DROP rooms, DROP bedrooms, DROP floor, DROP price, DROP heat, DROP city, DROP adress, DROP postal_code, DROP sold, DROP created_at');
    }
}
